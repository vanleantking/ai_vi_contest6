...
if __name__ == '__main__':
    ...
    # argparser.add_argument('--emb_file', help='Embedding file', default="./data/glove.6B.300d.txt", type=str)
    ...
    argparser.add_argument("--word_att", action='store_true', default=True, help="word attentional mechanism flag")
    ...
    # argparser.add_argument("--word_dim", type=int, default=300, help="word_embedding vector size")
